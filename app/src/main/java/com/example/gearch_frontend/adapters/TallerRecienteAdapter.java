...
public class TallerRecienteAdapter extends RecyclerView.Adapter<TallerRecienteAdapter.ViewHolder> {
    ...
    public TallerRecienteAdapter(Context context, List<Taller> talleres, View.OnClickListener onClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.taller_reciente_viewholder, parent, false);
